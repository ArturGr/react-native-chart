...
return (
_react2.default.createElement(Shape,{d:path,stroke:this.props.stroke,fill:this.props.fill,strokeWidth:1,__source:{fileName:_jsxFileName,lineNumber:26}}));}}]);return Circle;}(_react.Component);Circle.propTypes={radius:_propTypes.number.isRequired,x:_propTypes.number.isRequired,y:_propTypes.number.isRequired,onPress:_propTypes.func,fill:_propTypes.string,stroke:_propTypes.string};Circle.defaultProps={onPress:function onPress(){},radius:2,fill:C.BLACK,stroke:C.BLACK};exports.default=Circle;
