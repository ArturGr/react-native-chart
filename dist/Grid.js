Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/Grid.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');_propTypes=require('prop-types');var _react2=_interopRequireDefault(_react);
...
verticalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:verticalGridStyle,__source:{fileName:_jsxFileName,lineNumber:68}});})));}()));}}]);return Grid;}(_react.Component);Grid.propTypes={showGrid:_propTypes.bool,data:_propTypes.array.isRequired,verticalGridStep:_propTypes.number.isRequired,gridLineWidth:_propTypes.number,gridColor:_propTypes.oneOfType([_propTypes.number,_propTypes.string]),hideHorizontalGridLines:_propTypes.bool,hideVerticalGridLines:_propTypes.bool,height:_propTypes.number.isRequired,width:_propTypes.number.isRequired,type:_propTypes.oneOf(['line','bar','pie']).isRequired};Grid.defaultProps={};exports.default=Grid;
