...
item));});}()));}}]);return XAxis;}(_react.Component);XAxis.propTypes={axisColor:_propTypes.any.isRequired,axisLabelColor:_propTypes.any.isRequired,axisLineWidth:_propTypes.number.isRequired,data:_propTypes.arrayOf(_propTypes.array),showXAxisLabels:_propTypes.bool.isRequired,style:_propTypes.any,width:_propTypes.number.isRequired,align:_propTypes.string,labelFontSize:_propTypes.number.isRequired,xAxisTransform:_propTypes.func};XAxis.defaultProps={align:'center'};exports.default=XAxis;
