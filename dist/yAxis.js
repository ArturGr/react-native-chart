...
range.map(this._createLabelForYAxis)));}}]);return YAxis;}(_react.Component);YAxis.propTypes={axisColor:_propTypes.any,axisLineWidth:_propTypes.number,data:_propTypes.arrayOf(_propTypes.array).isRequired,height:_propTypes.number.isRequired,placement:_propTypes.oneOf(['left','right']),verticalGridStep:_propTypes.number.isRequired,yAxisTransform:_propTypes.func};YAxis.defaultProps={placement:'left'};exports.default=YAxis;
